...
import { FaGithub, FaTwitter, FaLinkedin, FaDribbble, FaMediumM, FaEnvelope } from "react-icons/fa"
  ...
  return (
    <footer className={className}>
      ...
      <div>
        ...
        {github && <Link href={github} icon={FaDribbble} />}
        {twitter && <Link href={twitter} icon={FaMediumM} />}
